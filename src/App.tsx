...
function App() {
  ...
  const [week, setWeek] = useState(1); // week currently selected in dropdown
  const [selectedEvent, setSelectedEvent] = useState<IEvent | object>({}); // event selected in dropdown
