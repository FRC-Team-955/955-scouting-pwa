...
export default function Dashboard({ appWeek, appKey, setEId, setEWeek }) {
  ...
  const [week, setWeek] = useState(appWeek); // the week currently seleceted in the dropdown
  const [eventKey, setEventKey] = useState(appKey); // the event id of the currently selected event (generated by TBA)
